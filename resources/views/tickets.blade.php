					...
					<div class="flex-none sm:flex">
						...
						<div class="flex-auto justify-evenly">
							<div class="flex items-center justify-between">
								...
								<div class="ml-auto text-blue-800">{{$reservation->ticket_number}}</div>
							</div>
							<div class="border-b border-dashed border-b-2 my-5"></div>
							<div class="flex items-center">
								<div class="flex flex-col">
									<div class="w-full flex-none text-lg text-blue-800 font-bold leading-none"> {{ $reservation->event->title }}</div>
								...
								<div class="flex flex-col mx-auto">
									...
									<div class="flex flex-col ">
										<div class="w-full flex-none text-lg text-green-500 font-bold leading-none"> {{ $reservation->event->date }}</div>
									</div>
								</div>
								<div class="flex flex-col py-5  justify-center text-sm ">
									<h6 class="font-bold text-center text-red-400">{{ $reservation->event->location }}</h6>
...
<div class="container mx-auto p-8">
	...
	<p class="text-lg">Ticket Number: {{ $reservation->ticket_number }}</p>
