...
<form action="{{route('filtration.events')}}" method="GET">
    @csrf
    <article class="filtrer-group">
        <header class="card-headear">
            <a href="#" data-toggle="collapse" data-target="#collapse_2" aria-expanded="true">
                <i class="icon-control fa fa-chevron-down"></i>
                <h6 class="title">Category</h6>
            </a>
        </header>
        <div class="filtrer-content collapse show" id="collapse_2" style="">
            <div class="card-body">
    ...
    {{-- <article class="filtrer-group">
        <div class="filtrer-content collapse show" id="collapse_3" style="">
            <div class="card-body">
                <div class="form-row">
                    ...
                    <div class="form-group text-right col-md-6">
                        <label>Max</label>
                        <input class="form-control" placeholder="$1,00" type="number" name="max">
                    </div>
                </div>
